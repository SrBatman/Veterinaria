...
public class DiscountManagement extends javax.swing.JFrame {
   ...
   Descuento discount = null;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Administracion de descuentos");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(inputQuantity, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(inputDiscount, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 110, 720, -1));
        ...
        Tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "DescuentoId", "Descuento", "N. Mascotas"
            }
        ) {
    ...
    private void showDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_showDataActionPerformed
        ...
        if (fila == -1 || inputID.getText().isEmpty()){
            JOptionPane.showMessageDialog(this, "No se ha seleccionado un descuento.");
        } else {
        String consulta = "select * from descuento where descuentoId=?";
        try {
    ...
    if (res.next()){
            ...
            discount.setDiscountId(res.getInt("descuentoId"));
            discount.setPorcentaje(res.getString("porcentaje"));
            discount.setCantidad(res.getInt("cantidad"));
         
            JOptionPane.showMessageDialog(this, discount.showData());
    ...
    private void TablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TablaMouseClicked
        ...
        int fila = Tabla.getSelectedRow();
         ...
         if (fila == -1){
            ...
            String sql = "select * from descuento where descuentoId=?";
            try {
            ...
            if (rs.next()){
                 ...
                 inputDiscount.setText(rs.getString("porcentaje"));
                 inputQuantity.setText(rs.getString("cantidad"));
    ...
    private void addData(){
        ...
        lista.put("Descuento", inputDiscount.getText());
        lista.put("Cantidad", inputQuantity.getText());
        ...
        if (!errorMessage.isEmpty()){
            ...
            discount = new Descuento(); 
                    ...
                    if (discount.setPorcentaje(inputDiscount.getText().replace("%", ""))){
                        
                        if (discount.setCantidad(inputQuantity.getText())){
                            //base de datos
                            db.insertDiscountData(lista);
                         
                        } else {
                            JOptionPane.showMessageDialog(this, "La cantidad de mascotas debe ser numerico.");
                        }
                        
                    } else {
                         JOptionPane.showMessageDialog(this, "El descuento debe ser numerico o porcentaje.");
                    }
    ...
    private void query(){
        ...
        try {
            ...
            while(rs.next()){
                empleado [0] = rs.getInt("descuentoId");
                empleado [1] = rs.getString("porcentaje") + "%";
                empleado [2] = rs.getString("cantidad");
            ...
            JOptionPane.showMessageDialog(this, "Los siguientes campos no pueden estar vacios: " + errorMessage);
             ...
             discount = new Descuento(); 
                    if (discount.setPorcentaje(inputDiscount.getText().replace("%", ""))){
                        ...
                        if (discount.setCantidad(inputQuantity.getText())){
                            //base de datos
                            db.editDiscountData(lista, Integer.parseInt(inputID.getText()));
...
//             
    ...
    private void deleteData(){
       ...
       String sql = "delete from descuento where descuentoId=?";
       int r = 0;
       try{
                PreparedStatement ps = conexion.prepareStatement(sql);
                ps.setInt(1, Integer.parseInt(inputID.getText()));
